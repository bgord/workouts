...
function Delta(props: { current: number; previous?: number }) {
  if (props.previous === undefined || props.current === props.previous) return null;
  ...
  return (
    <span
      data-color={difference > 0 ? "positive-400" : "danger-400"}
      data-cross="center"
      data-gap="1"
      data-stack="x"
    >
  ...
  return (
    <div data-gap="8" data-pt="5" data-stack="y">
      ...
      <ul data-gap="3" data-stack="y">
        {props.history.sessions.map((session, order) => {
          const previous = props.history.sessions.at(order + 1);
              ...
              <div className="c-card-footer">
                {session.oneRepMaxEstimate !== undefined && (
                  <div className="c-badge" data-variant="outline">
                    ...
                    <Delta current={session.oneRepMaxEstimate} previous={previous?.oneRepMaxEstimate} />
                  </div>
                )}
                ...
                <div className="c-badge" data-ml="auto" data-variant="outline">
                  ...
                  <Delta current={session.volume} previous={previous?.volume} />
                </div>
              </div>
            </li>
          );
